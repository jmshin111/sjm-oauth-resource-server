...
public class KafkaConsumerConfig {
	...
	public ConsumerFactory<String, Result> consumerFactory(){
		...
		DefaultKafkaConsumerFactory<String, Result> defaultFactory = new DefaultKafkaConsumerFactory<>(consumerConfigs());
		defaultFactory.setValueDeserializer(new JsonDeserializer<>(Result.class));
